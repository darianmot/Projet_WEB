<!--<div class="gallery items-3" id="banniere">-->
...
<div id="wowslider-container1">
	<div class="ws_images"><ul>
			<li><img src="media/images/abstarct_bluetexture.png" alt="abstarct_bluetexture" title="abstarct_bluetexture" id="wows1_0"/></li>
			<li><img src="media//images/planepictureshd.jpg" alt="wow slider" title="Plane-Pictures-HD" id="wows1_1"/></li>
